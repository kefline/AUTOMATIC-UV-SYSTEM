...
<!-- Mirrored from solar-admin-template.multipurposethemes.com/bs5/template/vertical/main/forms_general.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Oct 2024 13:50:42 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Solar Admin - Dashboard  General Form Elements </title>
          ...
          <div class="media-list media-list-hover mt-20">
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-success" href="#">
				<img src="https://solar-admin-template.multipurposethemes.com/bs5/images/avatar/1.jpg" alt="...">
			  </a>
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-danger" href="#">
				<img src="https://solar-admin-template.multipurposethemes.com/bs5/images/avatar/2.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-warning" href="#">
				<img src="https://solar-admin-template.multipurposethemes.com/bs5/images/avatar/3.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-primary" href="#">
				<img src="https://solar-admin-template.multipurposethemes.com/bs5/images/avatar/4.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
				  <a class="hover-primary" href="#"><strong>Evan</strong></a>
